...
def upload():
    if request.method=='POST': 
        ...
        img , (count , t_count) ,fname  ,confidance= test_img(img)  
        if t_count != 0:
    ...
    return render_template('/out.html' , img = 'saved.jpg' , face = fname , total = count ,t_count =t_count, imgpath = 'static/saved.jpg' , confidance = confidance)
